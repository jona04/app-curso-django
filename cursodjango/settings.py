...
# classe base utilizada como usuario
...
if AWS_ACCESS_KEY_ID:
    ...
    DEFAULT_FILE_STORAGE = 's3_folder_storage.s3.DefaultStorage'  # classe da bibli para fazer gestao da pasta static
    DEFAULT_S3_PATH = 'media'  # path padrao dos arquivos media
